...
public class RenderAlchemicalMortar extends TileEntitySpecialRenderer {
    private ResourceLocation rl = new ResourceLocation(Phlogiston.MODID + ":textures/blocks/wraithstone.png");
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        if (team.isFull()) {
            ...
            GL11.glTranslatef(0, (float)(Math.sin(team.getTicksFilled()/10F)*0.1F), 0);
